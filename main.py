...
if Battery_Capacity_kWh < 40:
    st.warning("Battery Capacity should be greater than 40 kWh")
elif Battery_Capacity_kWh > 100:
    st.warning("Battery Capacity should be less than 100 kWh")

Discount_Percentage = st.number_input("Discount Percentage")
if Discount_Percentage < 0:
    st.warning("Discount Percentage should be greater than 0")
elif Discount_Percentage > 20:
    st.warning("Discount Percentage should be less than 20")
...
if Units_Sold < 50:
    st.warning("Units Sold should be greater than 50")
elif Units_Sold > 398:
    st.warning("Units Sold should be less than 398")
